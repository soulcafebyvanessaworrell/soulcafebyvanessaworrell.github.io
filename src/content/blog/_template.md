...
locale: en               # the same language code as in the file name
draft: true              # true hides the post while you work; false publishes it
---

Write your post here, in Markdown.

Leave a blank line between paragraphs. That blank line is what starts a new paragraph.

## A heading looks like this

Use **bold** rarely, only when a word truly needs it. A link looks like [this](https://example.com). When the post is ready, set draft to false above and commit the file.
