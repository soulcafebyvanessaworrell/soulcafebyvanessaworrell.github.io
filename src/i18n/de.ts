...
export const dict = {
  ...
  form: {
    ...
    subject: "Betreff",
    attachment: "Anhang",
    attachmentHelp: "Optional. Ein Dokument oder Bild, bis etwa {size} MB.",
    message: "Nachricht",
  ...
  pages: {
    ...
    privacy: {
      ...
      cookies: {
        ...
        storage:
          "Eines bleibt in Ihrem eigenen Browser: die Sprache, die Sie gewählt haben, damit sich die Seite beim nächsten Mal gleich darin öffnet. Sie wird nie an uns gesendet.",
      },
      form: {
